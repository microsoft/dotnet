...
namespace bc_readme_gen
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string templateText = null, bcpathREADME = Path.Combine(bcpath, "README.md");
            ...
            var keysArrayLength = bcList.Keys.Count,
                keysArray = new string[keysArrayLength];
...
public class BreakingChange{
    public string Title,Path,Version;
}
