 ...
 * [LogMaster4Net](https://github.com/kerryjiang/LogMaster4Net) - It is a log server which can organize the logs from your different applications in a central place and keep the same log behaviors (loggers, appenders, levels and rules) like in the application self before.
